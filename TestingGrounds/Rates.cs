...
namespace TestingGrounds
{
    public class Rates
    {
        public static RateResponse GetRates()
        {
                ...
                */
                Request = new RequestType()
                {
                    ...
                    */
                    ...
                    Max Allowed: 1 
                    Length: 4
                    Indicates Rate API to display the new release features in Rate API response based on Rate release. See the What's New section for the latest Rate release. 
                ...
                Max Allowed: 1 
                Length: N/A
                Customer classification container. 
                ...
                */
                CustomerClassification = new CodeDescriptionType()
                {
                    ...
                    Valid values: 
                        ...
                        53 - Standard List Rates Length is not validated. 
                ...
                */
                Shipment = new ShipmentType()
                {
                    ...
                    ShipTo = new ShipToType()
                    {
                        ...
                        */
                        Address = new ShipToAddressType()
                        {
                            ...
                            Max Allowed: 1 
                            Length: 0
                            Residential Address flag. This field is a flag to indicate if the destination is a residential location. 
                            True if ResidentialAddressIndicator tag exists; false otherwise. This element does not require a value and if one is entered it will be ignored.
                            Empty Tag.
                            */
                    ...
                    */
                    ...
                    Required for the following ShipmentIndicationType values: 01 - Hold for Pickup at UPS Access Point™ 02 - UPS Access Point™ Delivery
                    */
                                    ...
                                    Dimensions = new HandlingUnitsDimensionsType()
                                    {
                                        ...
                                        */
                                        UnitOfMeasurement = new CodeDescriptionType()
                                        {
                                            ...
                                            Max Allowed: 1 
                                            Length: 2
                                            Code for UnitOfMeasurement for the line item dimension. Valid value: 
                                                IN = Inches
                                            */
                                            Code = "",
                    ...
                    */
                    Service = new CodeDescriptionType()
                    {
                        ...
                        Max Allowed: 1 
                        Length: 2
                        The code for the UPS Service associated with the shipment. Valid domestic values: NOTE: For all values, refer to Service Codes in the Appendix. 
                            01 = Next Day Air 
                            02 = 2nd Day Air 
                            03 = Ground 
                            12 = 3 Day Select 
                            ...
                            59 = 2nd Day Air A.M. Valid international values: 
                            ...
                            Dimensions = new DimensionsType()
                            {
                                ...
                                */
                                UnitOfMeasurement = new CodeDescriptionType()
                                {
                                    ...
                                    Max Allowed: 1 
                                    Length: 2
                                    Package dimensions unit of measurement code. Codes are: 
                                        ‘IN’ = Inches, 
                                        ‘CM’ = Centimeters.
                                    ...
                                    HazMatChemicalRecord = new HazMatChemicalRecordType[]
                                    {
                                        new HazMatChemicalRecordType()
                                        {
                                            ...
                                            */
                                            ...
                                            Max Allowed: 1 
                                            Length: 1…3
                                            The number of pieces of the specific commodity. Required if CommodityRegulatedLevelCode = LQ or FR. 
                                            ...
                                            */
                                            ...
                                            Max Allowed: 1 
                                            Length: 2
                                            Indicates the type of commodity - Fully Regulated (FR), Limited Quantity (LQ), Excepted Quantity (EQ), Lightly Regulated (LR). Default value is FR. 
                                            Valid values are 
                                                LR, 
                                                FR, 
                                                LQ, 
            ...
            return client.ProcessRate(security, request);
        }
    }
}
